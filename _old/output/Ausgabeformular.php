...
class Output{
  function Materialausgabe($bestellung){
    ...
    $pdf->Cell(0, 7, utf8_decode("Materialausgabe / -rücknahme"), 0, 1, "", 1);
    ...
    $pdf->Cell(0, 5, utf8_decode($bestellung->getAnlass()), 0, 1);
    ...
    $pdf->Cell(115, 5, utf8_decode("Bezeichnung"), 1, 0, "", 1);
    $pdf->Cell(25, 5, utf8_decode("Bestellt"), 1, 0, "", 1);
    $pdf->Cell(25, 5, utf8_decode("Ausgabe"), 1, 0, "", 1);
    $pdf->Cell(25, 5, utf8_decode("Rückgabe"), 1, 1, "", 1);
    ...
    while (!$materialliste->listenende()) {
       ...
       // Bei Seitenüberlauf neue Seite mit Header erstellen
      if($pdf->GetY()>=270){
        $pdf->AddPage();
        $pdf->SetY(20);
        $pdf->SetFillColor(200);
	  ...
	  if ($material->getBestaetigtemenge() !== "0"){
        if ($zeile%2 != 0) {  
          // gerade Zeilen
          $pdf->Cell(115, 5, utf8_decode($material->getBezeichnung()), "LR", 0, "", 1);
          $pdf->Cell(25, 5, utf8_decode($material->getBestaetigtemenge()), "LR", 0, "C", 1);
          $pdf->Cell(25, 5, "" , "LR", 0, "", 1);
          $pdf->Cell(25, 5, "", "LR", 1, "", 1);   
        } else {
          // ungerade Zeilen
          $pdf->Cell(115, 5, utf8_decode($material->getBezeichnung()), "LR");
          $pdf->Cell(25, 5, utf8_decode($material->getBestaetigtemenge()), "LR", 0, "C");
          $pdf->Cell(25, 5, "", "LR");
          $pdf->Cell(25, 5, "", "LR", 1);    
        }
		$zeile++;
     ...
     */
    $pdf->SetFont('Arial', 'B', 10);
    $pdf->Cell(0, 7, utf8_decode("Materialausgabe"), 0, 1);
    $y = $pdf->GetY();
    $pdf->SetFont('Arial', '', 10);
    $pdf->Cell(40, 5, utf8_decode("Ausgabe durch:"), 0, 0);
    $pdf->Cell(55, 5, "........................................", 0, 0);
    $pdf->Cell(40, 5, utf8_decode("Entgegennahme durch:"), 0, 0);
    $pdf->Cell(55, 5, "........................................", 0, 1);
    $pdf->Cell(40, 5, utf8_decode("Ausgabe am:"), 0, 0);
    $pdf->Cell(55, 5, "........................................", 0, 0);
    $pdf->Cell(40, 5, utf8_decode("Entgegennahme am:"), 0, 0);
    $pdf->Cell(55, 5, "........................................", 0, 1);
